...
אזי יורחב הביטוח על פי פרק זה לכסות , אם נרשם ברשימה כי הרחבה זו בתוקף אובדן או נזק שנגרם על ידי פריצה, שוד או כל ניסיון לכך.
...
הוצאות עבור תכנון, מדידה, פיקוח והשגחה של אדריכלים, מהנדסים, יועצים ,
...
- -נזק תוצאתי .4.1 כל אובדן או נזק תוצאתי שיגרם למבוטח כתוצאה מהסיכונים המבוטחים על פי פרק זה.
...
״ביטוח חסר״ 5.7 יילקחו בחשבון לעניין חישוב ביטוח חסר, בהתאם למפורט בתנאי .' מהתנאים המיוחדים לפרק א
...
הסכום המתקבל מהכפלת שיעור שכר העבודה בצמצום המחזור במשך אותו החלק מתקופת השיפוי המתחיל עם קרות מקרה

הביטוח ומסתיים לא יאוחר מתום מספר השבועות שצוין ברשימה כשבועות בהן יהיה שיפוי מלא, בניכוי כל חיסכון בשכר העבודה עקב מקרה הביטוח במשך אותה התקופה.
...
) - שילוב בין סעיף Consolidated Period ( תקופת שיפוי מאוחדת .8.2.1.3 :8.2.1.2 לסעיף 8.2.1.1 המבוטח רשאי, על פי בחירתו, להגדיל את מספר השבועות בהם לעיל, עד למספר השבועות 8.2.1.1 יקבל שיפוי מלא כמפורט בסעיף המצוין ברשימה, , לעיל 8.2.1.2 וזאת במקום תקופת השיפוי החלקי כמפורט בסעיף בניכוי כל חיסכון שנחסך בשכר העבודה ושנוכה כחיסכון ובהתאם הנ"ל. 8.2.1.1 לאמור בסיפא של סעיף

בגין הגדלת הוצאות התפעול: .8.2.2 שכר העבודה הנוסף, הנחוץ והסביר, שהוצא בלעדית לשם מניעה ו/או הקטנת הצמצום במחזור, אשר עלול היה להיגרם במשך תקופת השיפוי עקב מקרה בתנאי כי הסכום הנוסף הנ״ל לא יעלה על הסכום אשר היה . הביטוח . לעיל בגין צמצום המחזור, אלמלא הוצא 8.2.1 משתלם כשיפוי לפי סעיף שכר העבודה הנוסף הנ״ל. אחריות המבטח לא תעלה בשום מקרה על הסכום הנקוב ברשימה לגבי כל סעיף

המוזכר בה ובסך הכל על סכום הביטוח לפי פרק זה.

- .  סייגים לחבות המבטח לפרק ב׳. 9

אלא אם צוין אחרת ברשימה, המבטח לא ישפה את המבוטח על פי פרק זה בגין כל הפסד:
...
הביטוח על פי פרק זה מורחב לשפות את המבוטח בהתאם לאמור בהרחבות המפורטות וזאת (אם צוין ברשימה כי הם תקפים) להלן ובהתאם למפורט בכיסויים המפורטים להלן בכפוף לכל תנאי הפוליסה וסייגיה ועד לסכום המצוין בכל הרחבה אשר נרשם בה במפורש כי היא מוגבלת בסכום, ובכל מקרה ישפה המבטח את המבוטח רק בעד תגמולי ביטוח שסכומם עולה על סכום דמי ההשתתפות העצמית הנקובים ברשימה.
...
אלא אם צוין אחרת ברשימה, אחריותו של המבטח על פי הרחבה זו, מוגבלת

, הנמוך ביניהם. ₪  20,000,000מסכום הביטוח או ל 15%עד לסכום השווה ל ימי עבודה ראשונים 3סעיף זה כפוף להשתתפות עצמית של המבוטח, השווה ל , מקרות ההפרעה או ההפסקה או בסכום ההשתתפות העצמית הנקוב ברשימה הגבוה ביניהם.
...
- .  אל א אם צוין אחרת ברשימה, אחריותו של המבטח על פי הרחבה 10.3.4 ,₪  8,000,000מסכום הביטוח או ל 10%זו מוגבלת עד לסך השווה ל הנמוך ביניהם.
...
הביטוח על פי פרק זה מורחב לכסות הפסד נוסף שיגרם למבוטח בעקבות מקרה ככל שהוגדרו , ביטוח, אם לאחר קרות מקרה הביטוח ההוצאות המשתנות של העסק , ופורטו ברשימה, לא ירדו באופן יחסי לירידה במחזור. אלא אם צוין אחרת ברשימה מסכום 10%אחריותו של המבטח על פי הרחבה זו מוגבלת עד לסכום השווה ל , הנמוך ביניהם. ₪  4,000,000 הביטוח או ״ביטוח חסר״ בתנאים המיוחדים של פרק ב'. למניעת ספק, מובהר בזה כי אם ההוצאות הנ״ל לא פורטו

11.6 סכום זה הינו על בסיס נזק ראשון שאינו כפוף לתנאי ברשימה - לא יהיה סעיף זה בתוקף.

## עיכוב בקימום .10.12

הביטוח על פי פרק זה מורחב לכסות הפסד נוסף שיגרם למבוטח אם לאחר קרות עקב איסורים ו/או דרישות של הרשויות מקרה הביטוח חל עיכוב בקימום הנזק לגבי הקימום. הרחבה זו תחול רק אם לפני קרות הנזק, העסק פעל בהיתר מלא ורישיון תקף מאת הרשויות המוסמכות. מובהר בזאת כי הרחבה זו תקפה כל עוד התקופה בה חל העיכוב מהווה חלק מתקופת השיפוי הנקובה ברשימה ולא מתווספת אליה. אלא אם צוין אחרת ברשימה, אחריותו של המבטח על פי הרחבה זו מוגבלת עד , הנמוך ביניהם. ₪  8,000,000 מסכום הביטוח או 10%לסך השווה ל ״ביטוח חסר״ בתנאים

11.6 סכום זה הינו על בסיס נזק ראשון שאינו כפוף לתנאי .' המיוחדים של פרק ב
...
הביטוח על פי פרק זה יורחב לכסות אם נרשם ברשימה כי הרחבה זו בתוקף, קנסות ופיצויים שהמבוטח יהיה חייב בתשלומם על פי הסכם, בגין הימנעות מביצוע או איחור בביצוע התחייבויות חוזיות, שנבעו במישרין ובאופן בלעדי ממקרה ביטוח .' המכוסה על פי פרק א
...
הביטוח על פי פרק זה יורחב לכסות הוצאות , אם נרשם ברשימה כי הרחבה זו בתוקף נוספות שונות שאינן בגדר הוצאות תפעול, אשר הוצאו על ידי המבוטח במהלך תקופת השיפוי, ובלבד שהוצאתן הייתה הכרחית להחזרת מצב העסק לקדמותו לאחר קרות אלא אם צוין אחרת ברשימה, אחריותו של המבטח על פי הרחבה . מקרה הביטוח ,₪  1,250,000 מסכום הביטוח של פרק ב' או 15%זו מוגבלת עד לסכום השווה ל הנמוך ביניהם.

## הוצאות הכנת תביעה .10.16

הביטוח על פי פרק זה יורחב לכסות , אם נרשם ברשימה כי הרחבה זו בתוקף .' בהגדרות פרק ב 6.4 הוצאות הכנת תביעה, כהגדרתן בסעיף
...
, הביטוח על פי פרק זה יורחב לכסות , אם נרשם ברשימה כי הרחבה זו בתוקף במסגרת הרווח הגולמי, הוצאות מחקר ופיתוח. תגמולי הביטוח בגין הוצאות אלו מוגבלים לאובדן או נזק הנובעים ממקרה ביטוח המכוסה במסגרת פרק א׳, ביחס להוצאות מחקר ופיתוח והגדלת הוצאות התפעול, כמפורט להלן:

## . לגבי הוצאות מחקר ופיתוח: 10.17.1

במסגרת תקופת השיפוי, בגין כל שבוע עבודה (או חלק ממנו), אשר נגרמה בו: א.  הפסקה או הפרעה מלאה בפרויקטים או העברתם במלואם לעבודה להלן, בגין

- 10.17.3 מחדש - הסכום השבועי המבוטח, כהגדרתו בסעיף תקופת ההפסקה או ההפרעה, כאמור.
...
של פוליסה זו) ״הקטנת סכום 3 לתנאים הכלליים (חלק 13.15 בהמשך לאמור בסעיף הביטוח לאחר קרות מקרה הביטוח״, מובהר בזה כי לאחר קרות מקרה הביטוח אם יבקש המבוטח מהמבטח, יושב סכום הביטוח לקדמותו החל מיום כינון הנזק. אם נקוב ברשימה גבול אחריות, יושב זה לקדמותו החל מיום הנזק.

ההשבה כאמור הינה תמורת דמי ביטוח נוספים יחסיים עד לתום תקופת הביטוח. האמור בהרחבה זו לא יחול אם המבוטח יורה בכתב לא להחזיר את סכום הביטוח או את גבול האחריות לקדמותם כאמור.

)Loss Limit( אם צוין ברשימה גבול אחריות הכללי של המבטח לתקופת הביטוח לא תהיה הרחבה זו בתוקף.
...
היה ובעת קרות מקרה הביטוח, סכום הביטוח הכולל קטן מהסכום המתקבל מהכפלת -שיעור הרווח הגולמי בסכום המחזור השנתי, ובמקרה בו שכר העבודה בוטח בנפרד , מהכפלת שיעור שכר העבודה בסכום המחזור השנתי, יופחת השיפוי למבוטח באופן יחסי כיחס שבין סכום הביטוח לבין הסכום המתקבל מהכפלת שיעור הרווח הגולמי כאמור. חודשים, תוגדל מכפלת המחזור השנתי באופן יחסי. 12 היה ותקופת השיפוי עולה על
...
- ." .  אובדן או נזק כלשהו הנובע ו/או הקשור לבניה בשיטה הידועה כ"פל-קל 12.6
...
- אמצעים להקלת הסיכון .13.1 המבוטח ינקוט באמצעים להקלת הסיכון המבוטח על פי הפוליסה, כפי שיוסכם מעת לעת במשך תקופת הביטוח בכתב, תוך הזמן שיקבע לכך בין הצדדים או כפי שפורט

בפוליסה ו/או ברשימה, לפי העניין.
...
- , מבלי לגרוע מזכויות המבטח על פי דין או על פי הוראה אחרת כלשהי בפוליסה .13.5.1 המבטח רשאי לבטל את הביטוח בכל עת לפני תום תקופת הביטוח, לפי , שיקול דעתו, ובלבד שהודעה על כך תישלח למבוטח בכתב ובדואר רשום ימים לפני התאריך בו יתבטל הביטוח. 60 לפחות
...
- .  המבוטח רשאי לבטל את הביטוח בכל עת לפני תום תקופת הביטוח, לפי 13.5.2 שיקול דעתו, ובלבד שהודעה בכתב על כך תישלח למבטח לפני התאריך בו יתבטל הביטוח.
...
## חובת הגילוי ו/או החמרה בסיכון .13.6

- לא ענה המבוטח תשובות מלאות וכנות בעניין אשר שאלה לגביו הוצגה .13.6.1 למבוטח בטופס הצעת הביטוח או בדרך אחרת שבכתב או לא גילה למבטח עניין שיש בו כדי להשפיע על נכונותו של מבטח סביר לכרות את החוזה בכלל או לכרותו בתנאים שבו (להלן: "עניין מהותי"), יהיה המבטח רשאי לבטל את הפוליסה או להקטין את היקף חבותו על-פי ;1981הוראות חוק חוזה ביטוח התשמ"א

- הסתרה בכוונת מרמה מצד המבוטח של עניין שהוא ידע כי הוא עניין .13.6.2
- מהותי, דינה כדין מתן תשובה שאינה מלאה וכנה;
- .  שאלה גורפת שנשאלה על ידי המבטח, הכורכת עניינים שונים, ללא אבחנה 13.6.3 אלא אם הייתה סבירה בעת כריתת ביניהם, אינה מחייבת תשובה כאמור
- החוזה;
- בנוסף, במשך תקופת הביטוח יגלה המבוטח למבטח, בכתב, כל שינוי .13.6.4
- ; בעניין מהותי, וזאת באופן מידי מעת שנודע לו על כך
- לעניין זה יובהר, כי שינוי שחל אחרי מסירת הפוליסה למבוטח, בנושא .13.6.5 שצוין בה כעניין מהותי וכן דבר המגלה כי תשובה שניתנה לשאלה בעניין מהותי היתה לא נכונה ויש בה כדי להחמיר את סיכון המבטח החמרה
- ;" של ממש, יראו בהן גם כחלק מ"עניין מהותי
- 30 תוך .13.6.6 30 תוך
- ימים מהיום שנודע למבטח על תשובה שאינה מלאה וכנה או ימים מהיום שנמסרה למבטח הודעה על שינוי מהותי או שנודע על מידע כאמור למבטח בדרך אחרת, לפי המוקדם יותר (בהתייחס לשינוי מהותי), רשאי המבטח, ,כל עוד לא קרה מקרה הביטוח, לבטל את הפוליסה מיד בהודעה בכתב למבוטח. ביטל המבטח החוזה מכח תנאי זה, עובר לקרות מקרה ביטוח, זכאי המבוטח להחזר דמי ביטוח ששילם בעד התקופה שלאחר הביטול זולת
- אם המבוטח פעל בכוונת מרמה;
...
- ,) (לפי הענין 13.6.4 התשובה או אי מתן הודעה כאמור בסעיף
- .13.6.7.1 ניתנו בכוונת מרמה;
...
- בקרות מקרה הביטוח, על המבוטח או המוטב, להודיע למבטח בתוך זמן .13.7.1 של המבוטח לשיפוי כמו סביר מעת שנודע לו על קרות המקרה. כל תביעה באמצעות טופס תביעה תוגש הפוליסה לתשלום תגמולי ביטוח על פי גם שימציא המבטח למבוטח על פי בקשתו;
...
- אין המבטח חייב בתגמולי ביטוח בגין נזק שהמבוטח יכול היה למנוע, או .13.7.7 להקטין בקרות מקרה הביטוח או לאחר מכן, בנקיטת אמצעים סבירים או אמצעים שהמבטח הורה לו לנקוט;
...
- .  היה ותוגש תביעה בגין סיכון רעידת אדמה כאמור לעיל הן במסגרת 13.8.1.3 , פרק א׳ והן במסגרת פרק ב׳, במידה ונרכש סיכון זה בשני הפרקים אזי לעניין חישוב סכום ההשתתפות העצמית יתווסף לסכום הביטוח מסכום הביטוח לאתר, סכום השווה לאותו חלק 10% ממנו נגזרים של סכום הביטוח המבוטח על פי פרק ב׳, אשר מתייחס לאתר לתנאים המיוחדים 11.3 אשר נפגע. אך בכל מקרה (כאמור בסעיף לפרק ב׳), סך כל ההשתתפות העצמית על פי שני הפרקים לא תעלה על סכום ההשתתפות העצמית המרבי הנקוב בפרק א׳ של הרשימה בגין סיכון רעידת אדמה.
...
- .  היה ותוגש תביעה בגין סיכון נזקי טבע כאמור לעיל הן במסגרת 13.8.2.2 פרק א׳ והן במסגרת פרק ב׳, במידה ונרכש כיסוי בגין סיכון זה לתנאים המיוחדים 11.3 במסגרת שני הפרקים, אזי (כאמור בסעיף לפרק ב׳) לא יעלה סך ההשתתפות העצמית על פי שני הפרקים יחדיו, עקב אירוע אחד, על סכום ההשתתפות העצמית המרבי הנקוב בפרק א׳ של הרשימה בגין כיסוי נזקי טבע.
...
על המבוטח לנקוט אמצעי זהירות סבירים למניעת אבדן או נזק המכוסים על פי פוליסה זו ולהחזיק את הרכוש המבוטח במצב תקין ונאות.

## תחלוף .13.13

- . הייתה למבוטח בשל מקרה הביטוח גם זכות פיצוי או שיפוי כלפי צד שלישי 13.13.1 שלא מכוח חוזה ביטוח, עוברת זכות זו למבטח מששילם למבוטח או למוטב תגמולי ביטוח וכשיעור התגמולים ששילם.
- . המבטח אינו רשאי להשתמש בזכות שעברה אליו לפי סעיף זה באופן שיפגע 13.13.2 בזכותו של המבוטח לגבות מן הצד השלישי פיצוי או שיפוי מעל לתגמולים שקיבל מהמבטח.

. קיבל המבוטח מן הצד השלישי פיצוי או שיפוי שהיה מגיע למבטח לפי סעיף זה, עליו להעבירו למבטח. עשה פשרה, ויתור או פעולה אחרת הפוגעת בזכות שעברה למבטח, עליו לפצותו בשל כך כדי נזקו של המבטח. זה לא יחולו אם מקרה הביטוח נגרם שלא 13.13.3-13.13.1 הוראות תנאים בכוונה בידי אדם שמבוטח סביר לא היה תובע ממנו פיצוי או שיפוי, מחמת קירבת משפחה או יחס של עובד ומעביד שביניהם.

- 13.13.3
- . הוראות תנאי זה לא יחולו אם מקרה הביטוח נגרם שלא בכוונה בידי אדם 13.13.4 שמבוטח סביר לא היה תובע ממנו פיצוי או שיפוי, מחמת קירבת משפחה או יחס של עובד ומעביד שביניהם.
- , . המבטח מוותר על זכות התחלוף כלפי כל עובד של המבוטח, מועצת המנהלים 13.13.5 בעלי מניותיו של המבוטח וכן בני משפחותיהם וכן כלפי כל אדם או גוף משפטי שהמבוטח ויתר על זכות התביעה כלפיהם או התחייב בכתב לשפותם, לפני קרות מקרה הביטוח.

ויתור זה לא יחול במקרה של נזק שנגרם מתוך כוונת זדון.

## תקופת ההתיישנות .13.14

תקופת ההתיישנות של תביעה לתגמולי ביטוח היא שלוש שנים מיום קרות מקרה הביטוח.

## הקטנת סכומי הביטוח לאחר קרות מקרה הביטוח .13.15
...
- . הודעות של המבטח למבוטח או למוטב, בכל הקשור לפוליסה זו - תינתן 13.16.1 לפי מענם האחרון הידוע למבטח.
- . הודעות של המבוטח או של המוטב למבטח, תינתן למבטח בכתב למען 13.16.2 משרדו של המבטח,

כמצוין בכותרת הפוליסה או לכל מען אחר בישראל שעליו יודיע המבטח בכתב למבוטח או למוטב, מזמן לזמן.
